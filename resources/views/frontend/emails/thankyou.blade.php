                ...
                <td align="center" valign="top" id="bodyCell">
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" class="textContent">
                                                                                <div
                                                                                    ...
                                                                                    Here you can put a short
                                                                                    introduction to your email template.
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                    ...
                    <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="500"
                        ...
                        <tr>
                            <td align="center" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                    style="color:#FFFFFF;" bgcolor="#2E7D32">
                                    <tr>
                                        <td align="center" valign="top">
                                                                    ...
                                                                    <table border="0" cellpadding="0"
                                                                        ...
                                                                        <tr>
                                                                            <td valign="top" class="textContent">
                                                                                <div
                                                                                    style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:10px;color:#5F5F5F;line-height:135%;">
                                                                                    <span><strong>Hello
                                                                                            {{ $lead_details['name'] }},</strong></span>
                                                                                    <br><br>
                                                                                    <span>We appreciate your interest in
                                                                                        our product! Thank you for
                                                                                        considering
                                                                                        <strong>
                                                                                            {{ $lead_details['intrest'] }}
                                                                                        </strong>
                                                                                        for your needs.
                                                                                        <br><br>Our team is dedicated to
                                                                                        providing exceptional quality
                                                                                        and service, and we are excited
                                                                                    ...
                                                                                    <span><strong>Jainam</strong></span>
                                                                                    <br>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                ...
                                                                <td valign="top" bgcolor="#E1E1E1">
                                                                    <div
                                                                        ...
                                                                        <div>If you don't want to receive these emails
                                                                            from us in the future, please
                                                                            <a href="https://app.example.com/unsubscribe"
                                                                                target="_blank"
