            ...
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                    ...
                    @if (check_page_permission_by_string('Newsletter Manage'))
                        <li class="d-none main_dropdown @if (request()->is(['admin-home/newsletter/*', 'admin-home/newsletter'])) active @endif">
                    ...
                    @endif
                    <li class="d-none main_dropdown @if (request()->is(['admin-home/advertisement/*', 'admin-home/advertisement'])) active @endif">
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                            <span>{{ __('Advertisements') }}</span></a>
                        <ul class="collapse">
                            <li
                                class="{{ active_menu('admin-home/advertisement') }} @if (request()->is('admin-home/advertisement/edit/*')) active @endif">
                    ...
                    @if (check_page_permission_by_string('Case Study'))
                        <li class="d-none main_dropdown @if (request()->is(['admin-home/works/*', 'admin-home/works'])) active @endif">
                            <a href="javascript:void(0)" aria-expanded="true">
                                <i class="ti-layout"></i>
                    ...
                    @if (check_page_permission_by_string('Users Manage'))
                        <li class="main_dropdown @if (request()->is(['admin-home/frontend/user/*'])) active @endif">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-user"></i>
                    ...
                    @if (check_page_permission_by_string('Brand Logos'))
                        <li class="main_dropdown {{ active_menu('admin-home/brands') }}">
                            <a href="{{ route('admin.brands') }}" aria-expanded="true"><i
                                    class="ti-control-forward"></i>
                    ...
                    <li class="d-none main_dropdown @if (request()->is([
                        ...
                        <ul class="collapse ">
                                ...
                                <li class="main_dropdown @if (request()->is('admin-home/courses/*')) active @endif">
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="{{ active_menu('admin-home/courses/category') }}">
                                            <a
                                                href="{{ route('admin.courses.category.all') }}">{{ __('Category') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/courses/lesson') }}">
                                            <a
                                                href="{{ route('admin.courses.lesson.all') }}">{{ __('All Lessons') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/courses/review') }}">
                                            <a
                                                href="{{ route('admin.courses.review.all') }}">{{ __('All Reviews') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/courses/coupon') }}">
                                            <a
                                                href="{{ route('admin.courses.coupon.all') }}">{{ __('Coupons') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/courses/instructor') }}">
                                            <a
                                                href="{{ route('admin.courses.instructor.all') }}">{{ __('Instructor') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/courses/enroll') }}">
                                            <a
                                                href="{{ route('admin.courses.enroll.all') }}">{{ __('All Enrollment') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/courses/certificate') }}">
                                            <a
                                                href="{{ route('admin.courses.certificate.all') }}">{{ __('Certificate') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/courses/settings') }}">
                                            <a
                                                href="{{ route('admin.courses.settings') }}">{{ __('Settings') }}</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                                ...
                                <li class="main_dropdown @if (request()->is('admin-home/appointment/*')) active @endif">
                                    ...
                                    <ul class="collapse">
                                        <li class="{{ active_menu('admin-home/appointment/all') }}">
                                            <a
                                                href="{{ route('admin.appointment.all') }}">{{ __('All appointment') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/appointment/new') }}">
                                            <a
                                                href="{{ route('admin.appointment.new') }}">{{ __('New Appointment') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/appointment/category') }}">
                                            <a
                                                href="{{ route('admin.appointment.category.all') }}">{{ __('Category') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/appointment/booking-time') }}">
                                            <a
                                                href="{{ route('admin.appointment.booking.time.all') }}">{{ __('Booking Time') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/appointment/booking') }}">
                                            <a
                                                href="{{ route('admin.appointment.booking.all') }}">{{ __('All Appointment Booking') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/appointment/review') }}">
                                            <a
                                                href="{{ route('admin.appointment.review.all') }}">{{ __('All Reviews') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/appointment/form-builder') }}">
                                            <a
                                                href="{{ route('admin.appointment.booking.form.builder') }}">{{ __('Booking Form Builder') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/appointment/settings') }}">
                                            <a
                                                href="{{ route('admin.appointment.booking.settings') }}">{{ __('Settings') }}</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                                ...
                                <li class="main_dropdown @if (request()->is('admin-home/quote-manage/*')) active @endif">
                                    ...
                                    <ul class="collapse">
                                        <li class="{{ active_menu('admin-home/quote-manage/all') }}"><a
                                                href="{{ route('admin.quote.manage.all') }}">{{ __('All Quote') }}</a>
                                        </li>
                            ...
                            @if (check_page_permission_by_string('Package Orders Manage'))
                                <li
                                    class="main_dropdown @if (request()->is(['admin-home/payment-logs/report', 'admin-home/payment-logs', 'admin-home/package/*'])) active @endif
                                        ">
                                    <a href="javascript:void(0)" aria-expanded="true">
                                        {{ __('Package Orders Manage') }}</a>
                                    <ul class="collapse">
                                        <li class="{{ active_menu('admin-home/package/order-manage/all') }}"><a
                                                href="{{ route('admin.package.order.manage.all') }}">{{ __('All Order') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/package/order-manage/pending') }}"><a
                                                href="{{ route('admin.package.order.manage.pending') }}">{{ __('Pending Order') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/package/order-manage/in-progress') }}">
                                            <a
                                                href="{{ route('admin.package.order.manage.in.progress') }}">{{ __('In Progress Order') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/package/order-manage/completed') }}"><a
                                                href="{{ route('admin.package.order.manage.completed') }}">{{ __('Completed Order') }}</a>
                                        </li>
                                        <li
                                            class="{{ active_menu('admin-home/package/order-manage/success-page') }}">
                                            <a
                                                href="{{ route('admin.package.order.success.page') }}">{{ __('Success Order Page') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/package/order-manage/cancel-page') }}">
                                            <a
                                                href="{{ route('admin.package.order.cancel.page') }}">{{ __('Cancel Order Page') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/package/order-page') }}">
                                            <a
                                                href="{{ route('admin.package.order.page') }}">{{ __('Order Page Manage') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/package/order-report') }}">
                                            <a
                                                href="{{ route('admin.package.order.report') }}">{{ __('Order Report') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/payment-logs') }}"><a
                                                href="{{ route('admin.payment.logs') }}">{{ __('All Payment Logs') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/payment-logs/report') }}"><a
                                                href="{{ route('admin.payment.report') }}">{{ __('Payment Report') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/package/order-manage/settings') }}"><a
                                                href="{{ route('admin.package.settings') }}">{{ __('Settings') }}</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                                ...
                                <li
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="{{ active_menu('admin-home/jobs/category') }}"><a
                                                href="{{ route('admin.jobs.category.all') }}">{{ __('Category') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/new-jobs') }}"><a
                                                href="{{ route('admin.jobs.new') }}">{{ __('Add New Job') }}</a>
                                        </li>
                                        ...
                                        <li class="{{ active_menu('admin-home/jobs/success-page-settings') }}">
                                            <a
                                                href="{{ route('admin.jobs.success.page.settings') }}">{{ __('Job Success Page Settings') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/jobs/cancel-page-settings') }}">
                                            <a
                                                href="{{ route('admin.jobs.cancel.page.settings') }}">{{ __('Job Cancel Page Settings') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/jobs/applicant') }}"><a
                                                href="{{ route('admin.jobs.applicant') }}">{{ __('All Applicant') }}</a>
                                        </li>
                                ...
                                <li
                                    ...
                                    <ul class="collapse">
                                        <li class="{{ active_menu('admin-home/events/all') }}"><a
                                                href="{{ route('admin.events.all') }}">{{ __('All Events') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/events/category') }}"><a
                                                href="{{ route('admin.events.category.all') }}">{{ __('Category') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/events/new') }}"><a
                                                href="{{ route('admin.events.new') }}">{{ __('Add New Event') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/events/page-settings') }}"><a
                                                href="{{ route('admin.events.page.settings') }}">{{ __('Event Page Settings') }}</a>
                                        </li>
                                        ...
                                        <li class="{{ active_menu('admin-home/events/attendance') }}"><a
                                                href="{{ route('admin.events.attendance') }}">{{ __('Event Attendance settings') }}</a>
                                        </li>
                                        ...
                                        <li
                                            class="{{ active_menu('admin-home/events/payment-success-page-settings') }}">
                                            <a
                                                href="{{ route('admin.events.payment.success.page.settings') }}">{{ __('Payment Success Page Settings') }}</a>
                                        </li>
                                        <li
                                            class="{{ active_menu('admin-home/events/payment-cancel-pag-settings') }}">
                                            <a
                                        ...
                                        <li class="{{ active_menu('admin-home/events/settings') }}"><a
                                                href="{{ route('admin.events.settings') }}">{{ __('Settings') }}</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                                ...
                                <li
                                    ...
                                    <ul class="collapse">
                                        <li class="{{ active_menu('admin-home/products') }}"><a
                                                href="{{ route('admin.products.all') }}">{{ __('All Products') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/products/new') }}"><a
                                                href="{{ route('admin.products.new') }}">{{ __('Add New Product') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/products/category') }}"><a
                                                href="{{ route('admin.products.category.all') }}">{{ __('Category') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/products/subcategory') }}"><a
                                                href="{{ route('admin.products.subcategory.all') }}">{{ __('Sub Category') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/products/shipping') }}"><a
                                                href="{{ route('admin.products.shipping.all') }}">{{ __('Shipping') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/products/coupon') }}"><a
                                                href="{{ route('admin.products.coupon.all') }}">{{ __('Coupon') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/products/variants') }}"><a
                                                href="{{ route('admin.products.variants.all') }}">{{ __('Variants') }}</a>
                                        </li>
                                        ...
                                        <li class="{{ active_menu('admin-home/products/order-report') }}">
                                            <a
                                                href="{{ route('admin.products.order.report') }}">{{ __('Order Report') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/products/tax-settings') }}">
                                            <a
                                                href="{{ route('admin.products.tax.settings') }}">{{ __('Tax Settings') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/products/settings') }}">
                                            <a
                                                href="{{ route('admin.products.settings') }}">{{ __('Settings') }}</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                            @if (check_page_permission_by_string('Donations Manage') && !empty(get_static_option('donations_module_status')))
                                <li
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="{{ active_menu('admin-home/donations/donations-payment-logs') }}">
                                            <a
                                                href="{{ route('admin.donations.payment.logs') }}">{{ __('Donation Payment Logs') }}</a>
                                        </li>
                                        <li
                                            class="{{ active_menu('admin-home/donations/payment-success-page-settings') }}">
                                            <a
                                                href="{{ route('admin.donations.payment.success.page.settings') }}">{{ __('Payment Success Page Settings') }}</a>
                                        </li>
                                        <li
                                            class="{{ active_menu('admin-home/donations/payment-cancel-pag-settings') }}">
                                            <a
                                        ...
                                        <li class="{{ active_menu('admin-home/donations/report') }}">
                                            <a
                                                href="{{ route('admin.donations.report') }}">{{ __('Donation Report') }}</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                            @if (check_page_permission_by_string('Knowledgebase') && !empty(get_static_option('knowledgebase_module_status')))
                                <li
                                    class="main_dropdown {{ active_menu('admin-home/knowledge') }} @if (request()->is('admin-home/knowledge/*')) active @endif">
                                    <a href="javascript:void(0)" aria-expanded="true">
                                        {{ __('Knowledgebase') }}</a>
                                    <ul class="collapse">
                                        <li class="{{ active_menu('admin-home/knowledge') }}"><a
                                                href="{{ route('admin.knowledge.all') }}">{{ __('All Articles') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/knowledge/category') }}"><a
                                                href="{{ route('admin.knowledge.category.all') }}">{{ __('Topics') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/knowledge/new') }}"><a
                                                href="{{ route('admin.knowledge.new') }}">{{ __('Add New Article') }}</a>
                                        </li>
                            ...
                            @if (check_page_permission_by_string('Support Tickets') && !empty(get_static_option('support_ticket_module_status')))
                                <li
                                    class="main_dropdown {{ active_menu('admin-home/support-tickets') }} @if (request()->is('admin-home/support-tickets/*')) active @endif">
                                    <a href="javascript:void(0)" aria-expanded="true">
                                        {{ __('Support Tickets') }}</a>
                                    <ul class="collapse">
                                        <li class="{{ active_menu('admin-home/support-tickets') }}">
                                            <a
                                                href="{{ route('admin.support.ticket.all') }}">{{ __('All Tickets') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/support-tickets/new') }}"><a
                                                href="{{ route('admin.support.ticket.new') }}">{{ __('Add New Ticket') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/support-tickets/department') }}"><a
                                                href="{{ route('admin.support.ticket.department') }}">{{ __('Departments') }}</a>
                                        </li>
                                        ...
                                        @if (empty(get_static_option('home_page_page_builder_status')))
                                            @if (in_array($home_page_variant, ['01', '02', '03', '04']))
                                                ...
                                                <li class="{{ active_menu('admin-home/keyfeatures') }}">
                                                    <a
                                                        href="{{ route('admin.keyfeatures') }}">{{ __('Key Features') }}</a>
                                                </li>
                                                <li class="{{ active_menu('admin-home/home-page-01/about-us') }}"><a
                                                        href="{{ route('admin.homeone.about.us') }}">{{ __('About Us Area') }}</a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-01/service-area') }}">
                                                    <a
                                                        href="{{ route('admin.homeone.service.area') }}">{{ __('Service Area') }}</a>
                                                </li>
                                                @if ($home_page_variant != '03')
                                                    <li
                                                        class="{{ active_menu('admin-home/home-page-01/quality-area') }}">
                                                        <a
                                                            href="{{ route('admin.homeone.quality.area') }}">{{ __('Quality Area') }}</a>
                                                    </li>
                                                @endif
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-01/case-study-area') }}">
                                                    <a
                                                        href="{{ route('admin.homeone.case.study.area') }}">{{ __('Case Study Area') }}</a>
                                                </li>
                                                @if ($home_page_variant == '03')
                                                    <li
                                                        class="{{ active_menu('admin-home/home-page-01/cta-area') }}">
                                                        <a
                                                            href="{{ route('admin.homeone.cta.area') }}">{{ __('Call To Action Area') }}</a>
                                                    </li>
                                                @endif
                                                <li class="{{ active_menu('admin-home/home-page-01/testimonial') }}">
                                                    <a
                                                        href="{{ route('admin.homeone.testimonial') }}">{{ __('Testimonial Area') }}</a>
                                                </li>
                                                <li class="{{ active_menu('admin-home/home-page-01/price-plan') }}">
                                                    <a
                                                        href="{{ route('admin.homeone.price.plan') }}">{{ __('Price Plan Area') }}</a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-01/contact-area') }}">

                                                    <a
                                                        href="{{ route('admin.homeone.contact.area') }}">{{ __('Contact Area') }}</a>
                                                </li>
                                                ...
                                                @if (in_array($home_page_variant, ['04', '02']))
                                                    <li
                                                        class="{{ active_menu('admin-home/home-page-01/team-member') }}">
                                                        <a
                                                ...
                                                @if (in_array($home_page_variant, ['03', '02']))
                                                    <li
                                                        class="{{ active_menu('admin-home/home-page-01/brand-logos') }}">
                                                        <a
                                                            href="{{ route('admin.homeone.brand.logos') }}">{{ __('Brands Logos Area') }}</a>
                                                    </li>
                                                @endif
                                            @endif
                                            ...
                                            @if ($home_page_variant == '09')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-09/what-we-offer-area') }}">
                                            ...
                                            @if ($home_page_variant == '10')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-10/key-features-area') }}">
                                            ...
                                            @if ($home_page_variant == '11')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-11/key-features-area') }}">
                                            ...
                                            @if ($home_page_variant == '14')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-14/work-process-area') }}">
                                            ...
                                            @if ($home_page_variant == '15')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-15/featured-product-area') }}">
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-15/top-selling-product-area') }}">
                                            ...
                                            @if ($home_page_variant == '16')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-16/free-estimate-area') }}">
                                            ...
                                            @if ($home_page_variant == '18')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-18/product-categories') }}">
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-18/popular-item-area') }}">
                                            ...
                                            @if ($home_page_variant == '21')
                                                ...
                                                <li class="{{ active_menu('admin-home/home-21/services-area') }}">
                                                    <a href="{{ route('admin.home21.services') }}">
                                                        {{ __('Services Area') }}
                                                    </a>
                                                </li>
                                                <li class="{{ active_menu('admin-home/home-21/project-area') }}">
                                                    <a href="{{ route('admin.home21.project') }}">
                                                        {{ __('Project Area') }}
                                                    </a>
                                                </li>
                                                <li class="{{ active_menu('admin-home/home-21/counterup-area') }}">
                                                    <a href="{{ route('admin.home21.counterup') }}">
                                                        {{ __('Counterup Area') }}
                                                    </a>
                                                </li>
                                                <li class="{{ active_menu('admin-home/home-21/blog-area') }}">
                                                    <a href="{{ route('admin.home21.blog') }}">
                                                        {{ __('Blog Area') }}
                                                    </a>
                                                </li>
                                                <li class="{{ active_menu('admin-home/home-21/testimonial-area') }}">
                                                    <a href="{{ route('admin.home21.testimonial') }}">
                                                        {{ __('Testimonial Area') }}
                                                    </a>
                                                </li>
                                                <li class="{{ active_menu('admin-home/home-21/contact-area') }}">
                                                    <a href="{{ route('admin.home21.contact') }}">
                                                        {{ __('Contact Area') }}
                                                    </a>
                                                </li>
                                                <li class="{{ active_menu('admin-home/home-21/newsletter-area') }}">
                                                    <a href="{{ route('admin.home21.newsletter') }}">
                                                        {{ __('Newsletter Area') }}
                                                    </a>
                                                </li>
                                            @endif
                                            ...
                                            @if ($home_page_variant == '19')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-19/todays-deal-area') }}">
                                                    <a href="{{ route('admin.home19.todays.deal') }}">
                                                        {{ __('Todays Deal Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-19/updated-area') }}">
                                                    <a href="{{ route('admin.home19.updated.area') }}">
                                                        {{ __('Updated Area') }}
                                                    </a>
                                                </li>
                                                <li class="{{ active_menu('admin-home/home-page-19/store-area') }}">
                                                    <a href="{{ route('admin.home19.store.area') }}">
                                                        {{ __('Store Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-19/clothing-area') }}">
                                                    <a href="{{ route('admin.home19.clothing.area') }}">
                                                        {{ __('Clothing Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-19/popular-area') }}">
                                                    <a href="{{ route('admin.home19.popular.area') }}">
                                                        {{ __('Popular Sale Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-19/instagram-area') }}">
                                                    <a href="{{ route('admin.home19.instagram.area') }}">
                                                        {{ __('Instagram Area') }}
                                                    </a>
                                                </li>
                                                <li class="{{ active_menu('admin-home/home-page-19/promo-area') }}">
                                                    <a href="{{ route('admin.home19.promo.area') }}">
                                                        {{ __('Promotional Area') }}
                                                    </a>
                                                </li>
                                            @endif
                                            @if ($home_page_variant == '20')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-20/breaking-news-area') }}">
                                                    <a href="{{ route('admin.home20.breaking.news') }}">
                                                        {{ __('Breaking News Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-20/advertisement-area') }}">
                                                    <a href="{{ route('admin.home20.advertisement') }}">
                                                        {{ __('Advertisement Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-20/popular-news-area') }}">
                                                    <a href="{{ route('admin.home20.popular') }}">
                                                        {{ __('Popular News Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-20/video-news-area') }}">
                                                    <a href="{{ route('admin.home20.video') }}">
                                                        {{ __('Video News Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-20/sports-news-area') }}">
                                                    <a href="{{ route('admin.home20.sports') }}">
                                                        {{ __('Sports News Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-20/hot-news-area') }}">
                                                    <a href="{{ route('admin.home20.hot') }}">
                                                        {{ __('Hot News Area') }}
                                                    </a>
                                                </li>
                                            @endif
                                    ...
                                    <ul class="collapse">
                                        @if (empty(get_static_option('contact_page_page_builder_status')))
                                            <li class="{{ active_menu('admin-home/contact-page/contact-info') }}">
                                                <a
                                                    href="{{ route('admin.contact.info') }}">{{ __('Contact Info') }}</a>
                                            </li>
                                            ...
                                            <li class="{{ active_menu('admin-home/contact-page/section-manage') }}">
                                                <a
                                                    href="{{ route('admin.contact.page.section.manage') }}">{{ __('Section Manage') }}</a>
                                            </li>
                                        @endif
                                ...
                                <li class="main_dropdown @if (request()->is('admin-home/feedback-page/*')) active @endif">
                                    ...
                                    <ul class="collapse">
                                        <li class="{{ active_menu('admin-home/feedback-page/page-settings') }}">
                                            <a
                                                href="{{ route('admin.feedback.page.settings') }}">{{ __('Page Settings') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/feedback-page/form-builder') }}">
                                            <a
                                                href="{{ route('admin.feedback.page.form.builder') }}">{{ __('Form Builder') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/feedback-page/all-feedback') }}">
                                            <a
                                                href="{{ route('admin.feedback.all') }}">{{ __('All Feedback') }}</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                    ...
                    <li class="main_dropdown @if (request()->is([
                        ...
                        <ul class="collapse ">
                            ...
                            @if (check_page_permission_by_string('Home Variant'))
                                <li
                                    class="{{ active_menu('admin-home/appearance-setting/navbar-variant/settings') }}">
                                    <a href="{{ route('admin.navbar.settings') }}" aria-expanded="true">
                                        {{ __('Navbar Settings') }}
                                    </a>
                                </li>
                                <li
                                ...
                                <li class="{{ active_menu('admin-home/appearance-setting/footer-settings') }}">
                                    <a href="{{ route('admin.footer.settings') }}" aria-expanded="true">
                                ...
                                <li class="main_dropdown @if (request()->is('admin-home/popup-builder/*')) active @endif">
                                    ...
                                    <ul class="collapse">
                                        <li class="{{ active_menu('admin-home/popup-builder/all') }}"><a
                                                href="{{ route('admin.popup.builder.all') }}">{{ __('All Popup') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/popup-builder/new') }}"><a
                                                href="{{ route('admin.popup.builder.new') }}">{{ __('New Popup') }}</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                                ...
                                <li class="main_dropdown @if (request()->is('admin-home/form-builder/*')) active @endif">
                                    ...
                                    <ul class="collapse">
                                        <li class="{{ active_menu('admin-home/form-builder/all') }}">
                                            <a
                                                href="{{ route('admin.form.builder.all') }}">{{ __('All Custom Form') }}</a>
                                        </li>
                                        ...
                                        <li class="{{ active_menu('admin-home/form-builder/service-query') }}"><a
                                                href="{{ route('admin.form.builder.service.query') }}">{{ __('Service Query Form') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/form-builder/case-study-query') }}"><a
                                                href="{{ route('admin.form.builder.case.study.query') }}">{{ __('Case Study Query Form') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/form-builder/quote-form') }}"><a
                                                href="{{ route('admin.form.builder.quote') }}">{{ __('Quote Form') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/form-builder/order-form') }}"><a
                                                href="{{ route('admin.form.builder.order') }}">{{ __('Order Form') }}</a>
                                        </li>
                    ...
                    @if (check_page_permission('languages'))
                        <li class="main_dropdown @if (request()->is('admin-home/languages/*') || request()->is('admin-home/languages')) active @endif">
                            <a href="{{ route('admin.languages') }}" aria-expanded="true"><i
                                    class="ti-signal"></i>
